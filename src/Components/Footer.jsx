    ...
    return (
        <footer className="bg-[#101828]">
            <div className="container text-white">
                <div className="flex justify-between mt-12 space-y-6">
                    ...
                    <div className="flex space-x-8 w-[643px] text-sm">
                        ...
                        <div className="flex flex-col w-[285px] text-[#98A2B3] space-y-6">
