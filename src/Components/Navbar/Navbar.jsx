...
export default function Navbar() {
  return (
    <div className='md:container fixed rounded-t-2xl  md:rounded-3xl md:h-[72px] w-[90%] p-2 text-[#FCFCFD] backdrop-blur-xl flex justify-between items-center text-sm '>
        <div>
