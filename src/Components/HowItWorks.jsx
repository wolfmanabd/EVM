    ...
    <section id="#howitworks" className="bg-[#011929] text-white w-[100%]">
      <div className="container flex flex-col justify-between">
        <div className="md:flex  space-y-6  md:w-[420px] md:mt-12">
          <p className="text-[#EB8F02] text-sm mt-4">How It Works</p>
          <div className="hidden md:block">
            <Image src="/maxwell.png" alt="maxwell" width={200} height={400} />
          </div>
        </div>
        <div className=" md:w-[600px] md:mt-12 space-y-8">
          <h3 className="w-[100%] text-xl md:text-4xl font-bold md:w-[550]">
          ...
          <div className="flex flex-col  md:w-[600px] justify-between space-x-3 text-sm">
            <div className="flex flex-col space-y-3 md:w-[370px]">
              ...
              <p className="font-bold text-xl md:text-2xl md:w-[280px] mb-4">
          ...
          <div className="flex flex-col md:w-[600px] justify-between space-x-3 text-sm">
            ...
            <div className="flex flex-col space-y-2  md:w-[200px]">
              ...
              <p className="font-bold text-xl md:text-2xl md:w-[280px]">
          ...
          <div className="flex flex-col md:w-[600px] justify-between space-x-3 text-sm">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <p className="font-bold text-xl w-[100%] md:text-2xl md:w-[280px]">
