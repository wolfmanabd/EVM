    ...
    <section className="relative bg-[url(/hero.png)] w-[100vw] bg-cover bg-center h-[100vh]">
      ...
      <div className="relative z-10 container flex md:items-center justify-between h-full text-white text-center">
        ...
        <div className="flex flex-col md:flex-row md:justify-between mt-20 md:mt-10">
          ...
          <div className="flex-1 md:ml-20 md:-mt-6 relative mb-8">
            <div className="w-80 h-70 md:w-150 md:h-120 ">
              <Image src="/iPhone 15 Pro.png" alt="My Next.js App Logo" fill />
            </div>

            <div className="absolute bottom-20 md:right-40   md:-bottom-8 text-md bg-[#FCFCFD33] text-white backdrop-blur-md w-[300px] md:h-[152px] p-3 z-10 rounded-4xl text-start">
              <p>
